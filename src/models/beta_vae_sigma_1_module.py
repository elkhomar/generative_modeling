...
class beta_VAEModule(LightningModule):
    ...
    def encode(self, x):
        ...
        # log of sigma is constant 0 => sigma = 1
        log_var = torch.log(torch.zeros_like(mu))
        return mu, log_var
    ...
    def reparameterize(self, mu, log_var):
        ...
        # Sigma = identity to prevent mode collapse
        #std = torch.exp(0.5 * torch.ones_like(mu))
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.val_kl(kld)
        self.log("val/kl", self.val_kl, on_step=False, on_epoch=True, prog_bar=True)
    ...
    def test_step(self, batch, batch_idx):
        ...
        self.test_kl(kld)
        self.log("test/kl", self.test_kl, on_step=False, on_epoch=True, prog_bar=True)
