...
class VAE(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log('train reconstruction loss', mse)
        self.log('train KL divergence', kld)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log('val KL divergence', kld)
        self.log('val loss', loss)
m = torch.load("logs/model.pt")
torch.save(m.state_dict(), "logs/model_state_dict.pt")
m